...
function EmoteMenuStartClone(name, category)
    if category == "dances" then
        if RP.Dances[name] then
            OnEmotePlayClone(RP.Dances[name], name)
        end
    elseif category == "props" then
        if RP.PropEmotes[name] then
            OnEmotePlayClone(RP.PropEmotes[name], name)
        end
    elseif category == "emotes" then
        if RP.Emotes[name] then
            OnEmotePlayClone(RP.Emotes[name], name)
        end
    elseif category == "expression" then
...
function OnEmotePlayClone(emoteData, name)
    ...
    if not LoadAnim(dict) then
        local emoteName = name or "Unknown"
        EmoteChatMessage("'" .. emoteName .. "' " .. Translate('notvalidemote') .. "")
        return
    end
